...
namespace SMS.Data.Services
{
    public static class StudentServiceSeeder
    {
        public static void Seed(IStudentService svc)
        {
            ...
            var s1 = svc.AddStudent(new Student { Name = "Homer", Course = "COM741",   Age = 45, Email = "s1@email.com", Profile = new Profile { Grade = 45.0 } });   
            var s2 = svc.AddStudent(new Student { Name = "Marge", Course = "COM741",   Age = 40, Email = "s2@email.com", Profile = new Profile { Grade = 68.0 } });
            var s3 = svc.AddStudent(new Student { Name = "Bart",  Course = "Sleeping", Age = 13, Email = "s3@email.com", Profile = new Profile { Grade = 39.0 } });
            var s4 = svc.AddStudent(new Student { Name = "Lisa",  Course = "Maths",    Age = 10, Email = "s4@email.com", Profile = new Profile { Grade = 86.0 } });
